...
data class FreetimeGlassTokens(
    ...
    val darkSurfaceAlpha: Float = 0.035f,
    val lightSurfaceAlpha: Float = 0.03f,
    val darkFallbackAlpha: Float = 0.09f,
    val lightFallbackAlpha: Float = 0.10f,
    val saturation: Float = 1.55f,
    val brightness: Float = 0.05f,
    val pressedScale: Float = 1.10f,
    val highlightAlpha: Float = 0.22f,
    val tintAlpha: Float = 0.13f,
    val tintFallbackAlpha: Float = 0.12f,
    val edgeAlpha: Float = 0.22f,
    val minScrimAlpha: Float = 0.015f,
    val maxScrimAlpha: Float = 0.07f,
