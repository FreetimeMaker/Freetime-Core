...
data class FreetimeGlassTokens(
    ...
    val darkSurfaceAlpha: Float = 0.08f,
    val lightSurfaceAlpha: Float = 0.07f,
    val darkFallbackAlpha: Float = 0.14f,
    val lightFallbackAlpha: Float = 0.16f,
    ...
    val tintFallbackAlpha: Float = 0.18f,
    val edgeAlpha: Float = 0.22f,
    val minScrimAlpha: Float = 0.04f,
    val maxScrimAlpha: Float = 0.16f,
