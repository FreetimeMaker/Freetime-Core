...
private val FreetimeDarkColors = darkColorScheme(
    ...
    secondaryContainer = Color(0x24FFFFFF),
...
private val FreetimeLightColors = lightColorScheme(
    ...
    primaryContainer = Color(0x24000000),
    onPrimaryContainer = Color(0xFF111111),
    secondary = Color(0xFF3F3F3F),
    onSecondary = Color.White,
    secondaryContainer = Color(0x18000000),
...
fun FreetimeTheme(
    ...
    MaterialTheme(
        ...
        shapes = MaterialTheme.shapes.copy(
            extraSmall = FreetimeGlassDefaults.compactShape,
            small = FreetimeGlassDefaults.compactShape,
            medium = FreetimeGlassDefaults.shape,
            large = FreetimeGlassDefaults.shape,
            extraLarge = FreetimeGlassDefaults.shape,
        ),
        content = content,
    )
}
